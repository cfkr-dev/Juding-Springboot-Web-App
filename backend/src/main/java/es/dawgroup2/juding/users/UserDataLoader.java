...
public class UserDataLoader {
    ...
    public void userLoader() throws IOException {
        ...
        userRepository.save(new User("JU-1234567893", "José Luis", "Toledano", "jl.toledano.2018@alumnos.urjc.es", 678956320, Gender.H, new Date(953596800), "00412323W", "Madrid Centro", 50, Belt.N4, "/static/JU-1234567893.jpg", "jl.toledano", "joseluis", "Question?", "Answer", 2).setRefereeRange(RefereeRange.ESTAN));
        userRepository.save(new User("JU-1234567894", "José Luis", "Pendiente", "jl.pendiente.2018@alumnos.urjc.es", 678956321, Gender.H, new Date(953596800), "00412354W", "Madrid Centro", 40, Belt.N7, "/static/1234567890.jpg", "jl.pendiente", "jlpendiente", "Question?", "Answer", 2).setRefereeRange(RefereeRange.SOLIC));
    }
}
