...
public class UserDataLoader {
    ...
    public void userLoader() throws IOException, ParseException {
        ...
        userRepository.save(new User("JU-1234567985", "Serafín", "Miguélez", Gender.H, 689758489, "juding.noreply@gmail.com", dateService.stringToDate("23/11/2000"), "12345678Z", "ser.miguelez", "ser.miguelez", "Serafin?", "Serafin", imageService.uploadProfileImage("/static/1234567890.jpg"), Belt.N10, "Madrid Norte", 95, RefereeRange.S, List.of(Role.R)));
    }
}
