...
public class UserDataLoader {
    ...
    public void userLoader(){
        ...
        userRepository.save(new User("1234567890", "Diego", "Guerrero", "d.guerrero.2018@alumnos.urjc.es", 601234567, 'H', new Date(new java.util.Date().getTime()), "12345678Z", "Madrid Centro", 80, "BAm", "d.guerrero", "diego", "Question?", "Answer", 1));
        ...
        userRepository.save(new User("JU-1234567893", "José Luis", "Toledano", "jl.toledano.2018@alumnos.urjc.es", 678956320, 'H', new Date(953596800), "00412323W", "Madrid Centro", 80, "N3", "jl.toledano", "joseluis", "Question?", "Answer", 2));
    }
}
