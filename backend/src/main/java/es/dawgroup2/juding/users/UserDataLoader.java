...
public class UserDataLoader {
    ...
    public void userLoader() throws IOException, ParseException {
        ...
        userRepository.save(new User("1234567892", "Ismael", "González", Gender.H, 689523154, "i.gonzalezs.2018@alumnos.urjc.es", dateService.stringToDate("15/04/2000"), "12345534P", "i.gonzalezs", passwordEncoder.encode("i.gonzalezs"), "Ismael?", "Ismael", imageService.uploadProfileImage("/static/1234567892.jpg"), Belt.AzM, "Madrid Centro", 60, null, List.of(Role.C,Role.R,Role.A)));
