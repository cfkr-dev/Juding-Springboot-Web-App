...
public class UserDataLoader {
    ...
    public void userLoader() throws IOException, ParseException {
        ...
        User graham = new User("1234567890", "Diego", "Guerrero", Gender.H, 601234567, "d.guerrero.2018@alumnos.urjc.es", dateService.stringToDate("30/10/2000"), "12345678Z", "d.guerrero", "d.guerrero", "Diego?", "Diego", imageService.uploadProfileImage("/static/1234567890.jpg"), Belt.BAm, "Madrid Centro", 80 , null, List.of(Role.C));
